...
//Defining the function for generating V type random numbers
void vtype(char *str1,char *str2, int len)
{
int i,j;
double temp;
FILE *fp1;
...
//End function for generating V type random numbers
...
//Defining the function for calculating the Varaince of random numbers
double variance(char *str)
{
int i=0,c;
FILE *fp;
